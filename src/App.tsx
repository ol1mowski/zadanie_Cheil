    ...
    <div className="min-h-screen bg-background py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          <div className="card">
            ...
            <div className="text-center">
              <div className="text-6xl font-bold text-green mb-4">
                {count}
              </div>
              <button 
          ...
          <div className="card">
            ...
            <div className="space-y-3 text-lightText">
              <p>
                Edytuj <code className="bg-lightText/10 px-2 py-1 rounded text-sm font-mono">src/App.tsx</code> i zapisz, aby przetestować HMR
              </p>
              <p>
        ...
        <div className="mt-12 space-y-6">
          ...
          <div className="card">
            <h3 className="text-xl font-semibold text-text mb-4">Test typografii i spacing</h3>
            <div className="space-y-4">
              <h1 className="text-4xl font-bold text-text">Nagłówek H1</h1>
              <h2 className="text-3xl font-semibold text-darkBlue">Nagłówek H2</h2>
              <h3 className="text-2xl font-medium text-green">Nagłówek H3</h3>
              <p className="text-lg text-lightText leading-relaxed">
                To jest przykładowy tekst z customowym fontem SamsungOne i kolorami Samsung.
                Możesz zobaczyć różne rozmiary, wagi i kolory tekstu.
              </p>
            </div>
          </div>

          <div className="card">
            <h3 className="text-xl font-semibold text-text mb-4">Test komponentów</h3>
        ...
        <div className="text-center mt-12">
          <p className="text-lightText">
            Projekt skonfigurowany przez doświadczonego developera React + TypeScript
          </p>
        </div>
      </div>
    </div>
